    ...
    return ( 
      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
        ...
        <h1 className="text-center mb-10 text-xl font-bold">About Learn Dash Code</h1>
            ...
            <ul>
                <li className="text-center mb-5"><Link href="https://www.mongodb.com/" target="_blank"><span className="cursor-pointer text-xl text-red-500">MongoDB</span></Link></li>
                ...
                <li className="text-center mb-5"><Link href="https://www.npmjs.com/package/express" target="_blank">
          ...
          <li className="text-center mb-5"><Link href="https://reactjs.org/" target="_blank"><span className="cursor-pointer text-xl text-red-500">React</span></Link></li>
          ...
          <li className="text-center mb-5"><Link href="https://nodejs.org/en/" target="_blank"><span className="cursor-pointer text-xl text-red-500">Node</span></Link></li>
